...
\firstname{Michaël} % Your first name
\familyname{ROYNARD} % Your last name
...
\homepage{fr.linkedin.com/in/micha\%C3\%ABl-roynard-4a572ab6}{Profil Linkedin} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
\extrainfo{\href{https://github.com/dutiona/}{Profil Github}}%~\footnote{https://github.com/dutiona} \href{https://fr.linkedin.com/in/micha\%C3\%ABl-roynard-4a572ab6}{Linkedin}~\footnote{https://fr.linkedin.com/in/michaël-roynard-4a572ab6}}
